...
void do_blurring_method_control_settings()
{
    ...
    switch (gtk_combo_box_get_active(GTK_COMBO_BOX_TEXT(blurring_page_bm)))
    {
    case 0:
        if (p_blurring == 1)
        {
...
void update_customck()
{
    ...
    if (gtk_combo_box_get_active(GTK_COMBO_BOX_TEXT(blurring_page_convkern)) == 7)
    {
...
void create_window_type_specific_overrides_edit(GtkWidget *widget, gpointer data)
{
    ...
    fade_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(fade_frame_no), _("Force enable"));
    fade_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(fade_frame_no), _("Force disable"));

    switch (wintypeval.fade)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fade_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fade_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fade_frame_no), TRUE);
        break;
    }
    ...
    shadow_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(shadow_frame_no), _("Force enable"));
    shadow_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(shadow_frame_no), _("Force disable"));
    switch (wintypeval.shadow)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(shadow_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(shadow_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(shadow_frame_no), TRUE);
        break;
    }
    ...
    fshadow_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(fshadow_frame_no), _("Force enable"));
    fshadow_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(fshadow_frame_no), _("Force disable"));
    switch (wintypeval.full_shadow)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fshadow_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fshadow_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(fshadow_frame_no), TRUE);
        break;
    }
    ...
    cshadow_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(cshadow_frame_no), _("Force enable"));
    cshadow_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(cshadow_frame_no), _("Force disable"));
    switch (wintypeval.clip_shadow_above)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(cshadow_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(cshadow_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(cshadow_frame_no), TRUE);
        break;
    }
    ...
    ig_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(ig_frame_no), _("Force enable"));
    ig_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(ig_frame_no), _("Force disable"));
    switch (wintypeval.redir_ignore)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ig_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ig_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ig_frame_no), TRUE);
        break;
    }
    ...
    ff_frame_force_on = gtk_radio_button_new_with_label(gtk_radio_button_get_group(ff_frame_no), _("Force enable"));
    ff_frame_force_off = gtk_radio_button_new_with_label(gtk_radio_button_get_group(ff_frame_no), _("Force disable"));
    switch (wintypeval.force_focus)
    {
    case 0:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ff_frame_force_off), TRUE);
        break;
    case 1:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ff_frame_force_on), TRUE);
        break;
    case 2:
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ff_frame_no), TRUE);
        break;
    }
    ...
    gtk_toggle_button_set_active(GTK_CHECK_BUTTON(opacity_frame_cb), FALSE);
    ...
    {
        gtk_widget_set_sensitive(opacity_frame_s, TRUE);
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(opacity_frame_cb), TRUE);
...
void create_shadow_page_ser_window(GtkWidget *widget, gpointer data)
{
    ...
    gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ser_cb), TRUE);
    if (is_enabled == 0)
    {
        gtk_toggle_button_set_active(GTK_CHECK_BUTTON(ser_cb), FALSE);
    }
...
void rendering_options_page_b_on_changed(GtkComboBox *widget, gpointer user_data)
{
    ...
    switch (gtk_combo_box_get_active(GTK_COMBO_BOX_TEXT(rendering_options_page_b)))
    {
    case 1:
    case 3:
...
{
    write_config_str_value("backend", rendering_options_page_backend_actualnames[gtk_combo_box_get_active(GTK_COMBO_BOX_TEXT(rendering_options_page_b))]);
...
void create_win_det_page()
{
    ...
    win_det_window_grouping_detect_transient_win = gtk_radio_button_new_with_label(gtk_radio_button_get_group(win_det_window_grouping_none), _("Use the 'WM_TRANSIENT_FOR' hint for grouping"));
    win_det_window_grouping_detect_client_leader = gtk_radio_button_new_with_label(gtk_radio_button_get_group(win_det_window_grouping_none), _("Use the 'WM_CLIENT_LEADER' hint for grouping"));
...
void show_pid_file_browse_dialog(GtkWidget *widget, gpointer data)
{
    ...
    misc_page_pid_file_dialog = gtk_file_chooser_dialog_new(_("Save File"), window, GTK_FILE_CHOOSER_ACTION_SAVE, _("Cancel"), GTK_RESPONSE_CANCEL, _("Save"), GTK_RESPONSE_ACCEPT, NULL);
...
void show_log_file_browse_dialog(GtkWidget *widget, gpointer data)
{
    ...
    misc_page_log_file_dialog = gtk_file_chooser_dialog_new(_("Save File"), window, GTK_FILE_CHOOSER_ACTION_SAVE, _("Cancel"), GTK_RESPONSE_CANCEL, _("Save"), GTK_RESPONSE_ACCEPT, NULL);
